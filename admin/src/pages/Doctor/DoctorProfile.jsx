        ...
        <div className='m-5'>
            <div className='flex flex-col sm:flex-row gap-4'>
                <div className='sm:w-1/3'>
                    <div className='border border-stone-100 rounded-lg p-4 bg-white'>
                ...
                <div className='sm:w-1/3 border border-stone-100 rounded-lg p-6 bg-white'>
                    <h3 className='text-xl font-medium text-gray-700 mb-4'>Change Password</h3>
                        <div className='flex flex-col gap-3'>
                            ...
                            <button 
                                ...
                                className='px-4 py-1.5 bg-primary text-white text-sm rounded-full hover:bg-primary/90 transition-all'
                            >
                                Change Password
                            </button>
                        </div>
